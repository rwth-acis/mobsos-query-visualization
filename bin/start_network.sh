...
java -cp "lib/*" i5.las2peer.tools.L2pNodeLauncher -p 9011 "startService('i5.las2peer.services.mobsos.queryVisualization.QueryVisualizationService@1.0','someNewPass')" startWebConnector interactive
