...
public class ServiceTest {
  ...
  private final ServiceNameVersion testServiceClass = new ServiceNameVersion(
    QueryVisualizationService.class.getCanonicalName(),
    "1.0"
  );
  ...
  private static final String TEST_FILTER_URI =
    mainPath + filterPath + testDBName + "/" + testFilterName;
  ...
  public static void setUpDB() {
    ...
    try {
      ...
      testQuery.put(
        "query",
        "SELECT * FROM `DATABASE_CONNECTIONS` WHERE `KEY` = ?"
      );
  ...
  public void testGetDatabases() {
    try {
      ...
      for (String s : new String[] { "DatabaseKeys", "string", testDBName }) {
        ...
        expected.add(inner);
        assertTrue(
          inner.toString() + " should be in the data. Actual data: " + actual,
          actual.contains(inner)
        );
      }

      System.out.println(
        "Result of 'GetDatabases': " + result.getResponse().trim()
      );
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
  ...
  public void testAddDatabase() {
    try {
      ...
      System.out.println(
        "Result of 'addDatabase': " + result.getResponse().trim()
      );
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
  ...
  public void testRemoveDatabase() {
    try {
      ...
      System.out.println(
        "Result of 'removeDatabase': " + result.getResponse().trim()
      );
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
  ...
  public void testGetFilters() {
    try {
      ...
      System.out.println(
        "Result of 'GetFilters': " + result.getResponse().trim()
      );
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
  ...
  public void testAddFilter() {
    try {
      ...
      System.out.println(
        "Result of 'AddFilter': " + result.getResponse().trim()
      );
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
  ...
  public void testRemoveFilter() {
    try {
      ...
      ClientResponse result = client.sendRequest(
        "DELETE",
        mainPath + filterPath + testDBName + "/asohusnaoue",
        ""
      );
      assertEquals(404, result.getHttpCode());
      ...
      System.out.println(
        "Result of 'removeFilter': " + result.getResponse().trim()
      );
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
  ...
  public void testQuery() {
    try {
      ...
      try {
        key =
          Integer.parseInt(JSONValue.parse(result.getResponse()).toString());
      } catch (Exception e) {
        fail(
          "Received data is not a query id: " +
          JSONValue.parse(result.getResponse()).toString()
        );
      }
